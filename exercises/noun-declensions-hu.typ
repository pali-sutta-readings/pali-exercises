...
#table(
  columns: 2,
  [Az idős szerzetes #B[sétára] megy.], [Thero cārikaṁ carati.],
...
#table(
  ...
  [Az alamizsnát nem szórakozásért esszük, \ nem élvezetért ...], [Mayaṁ piṇḍapātaṁ bhuñjāma neva davāya, \ na madāya ...],
)
...
#table(
  ...
  [#strong[nibbāna]], [#emph[\(nt)] kialvás; kioltás; eloltás; #emph[from nibbāti]],
  ...
  [#strong[pavisati]], [betér; belép; bemegy],
...
+ Bhagavā Rājagahaṁ piṇḍāya pavisati. \ // anki: front
  #fillin(15cm, "A Magasztos betér Rājagahába alamizsnáért.") // anki: back
...
+ Kassapo kālena odanaṁ bhuñjati. (#emph[Kassapa] egy név.) \ // anki: front
...
+ Nandiyo sakko bhagavantaṁ upasaṅkamati kālena kālaṁ dassanāya. \ (#emph[Nandiya] egy név. #emph[Bhagavant]: a Magasztos.) \ // anki: front
...
#fillin(15cm, "'Megvan bennem az éberség megvilágosodási tényezője' – ezt tudja.") // anki: back
...
+ Sissā ācariyassa bhattaṁ haranti. \ // anki: front
  #fillin(6cm, "A tanítványok viszik az ételt a tanítónak. / viszik a tanító ételét.") // anki: back
...
+ A fiúk virágokat visznek a szerzetesnek. / viszik a szerzetes virágait. \ // anki: back
...
+ A szakács elkészíti (megfőzi) az ételt a tanítványoknak. / megfőzi a tanítványok ételét. \ // anki: back
