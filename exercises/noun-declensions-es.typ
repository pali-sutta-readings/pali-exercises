...
+ Naro/Puriso gāmaṁ gacchati. \ // anki: front
  #fillin(6cm, "El hombre va a la aldea.") // anki: back

+ Kumāro assaṁ passati. \ // anki: front
  #fillin(6cm, "El muchacho ve al caballo.") // anki: back

+ Buddho dhammaṁ bhāsati. \ // anki: front
  #fillin(6cm, "El Buddha habla sobre el Dhamma.") // anki: back

+ Puriso Buddhaṁ saranaṁ gacchati. \ // anki: front
  #fillin(6cm, "El hombre va al Buddha como refugio.") // anki: back

], block[
#set enum(start: 5)

+ Ācariyo pañhaṁ pucchati. \ // anki: front
  #fillin(6cm, "El maestro hace la pregunta.") // anki: back

+ Migo udakaṁ pivati. \ // anki: front
  #fillin(6cm, "El ciervo bebe agua.") // anki: back

+ Sīho maṁsaṁ rakkhati. \ // anki: front
  #fillin(6cm, "El león guarda la carne.") // anki: back
...
+ El muchacho come el arroz. \ // anki: back
  #fillin(6cm, "Kumāro odanaṁ bhuñjati.") // anki: front

+ El león va al árbol. \ // anki: back
  #fillin(6cm, "Sīho rukkhaṁ gacchati.") // anki: front

+ El león mastica la carne. \ // anki: back
...
+ El maestro le dice al estudiante. \ // anki: back
  #fillin(6cm, "Ācariyo sissaṁ vadati.") // anki: front

+ El estudiante escucha al maestro. \ // anki: back
  #fillin(6cm, "Sisso ācariyaṁ suṇāti.") // anki: front

+ La deidad protege el mundo. \ // anki: back
...
+ Narā magge caranti. \ // anki: front
  #fillin(6cm, "Los hombres caminan por los senderos.") // anki: back

+ Coro ratane gaṇhāti. \ // anki: front
  #fillin(6cm, "El ladrón agarra los tesoros.") // anki: back

+ Sūdo macche pacati. \ // anki: front
  #fillin(6cm, "El cocinero cocina los peces.") // anki: back

], block[
#set enum(start: 4)

+ Kumāro asse rakkhati. \ // anki: front
  #fillin(6cm, "El muchacho guarda los caballos.") // anki: back

+ Migā rukkhe upasaṅkamanti. \ // anki: front
  #fillin(6cm, "Los ciervos se acercan a los árboles.") // anki: back

+ Rājāno (#E[plural]) coraṁ gaṇhanti. \ // anki: front
  #fillin(6cm, "Los reyes atrapan al ladrón.") // anki: back
...
+ Los hombres ven los árboles. \ // anki: back
  #fillin(6cm, "Narā rukkhe passanti.") // anki: front

+ Los muchachos llevan los cuencos. \ // anki: back
  #fillin(6cm, "Kumārā patte haranti.") // anki: front

+ Los reyes (irreg: #E[rājāno]) protegen los tesoros. \ // anki: back
  #fillin(6cm, "Rājāno ratane rakkhanti.") // anki: front

], block[
#set enum(start: 4)

+ El estudiante se acerca a los maestros. \ // anki: back
  #fillin(6cm, "Sisso ācariye upasaṅkamati.") // anki: front

+ Los (pl.) ciervos beben agua. \ // anki: back
  #fillin(6cm, "Migā udakaṁ pivanti.") // anki: front

+ El maestro camina hacia las aldeas. \ // anki: back
...
#table(
  ...
  [El hueso cubierto de piel; se ve hermoso con las ropas.], // anki: back
)
...
#table(
  ...
  [La Comunidad entrega esta tela de Kaṭhina al Ven. Amaro.], // anki: back
)
...
#table(
  ...
  [#strong[hi]], [#emph[\(ind)] en verdad; certamente; verdaderamente],
...
+ Ācariyo sissena saddhiṁ gacchati. (#pali[saddhiṁ] = "junto con") \ // anki: front
  #fillin(15cm, "El maestro va junto con el estudiante.") // anki: back

+ Abhiññāya sambodhāya nibbānāya saṁvattati. (SN 56.11) \ // anki: front
  #fillin(15cm, "Conduce al conocimiento superior, al despertar, al Nibbāna.") // anki: back

+ Bhagavā Rājagahaṁ piṇḍāya pavisati. \ // anki: front
  #fillin(15cm, "El Bienaventurado entra en Rājagaha para pedir limosna.") // anki: back
...
+ Na hi verena veraṁ sammati. (Dhp 5 simpl.) \ // anki: front
  #fillin(15cm, "En verdad, no por la hostilidad se calma la hostilidad.") // anki: back
...
+ Kusalehi dhammehi cittaṁ vimuccati. \ // anki: front
  #fillin(15cm, "Por las cualidades sanas se libera la mente.") // anki: back

+ Kena ādittaṁ? Dukkhehi domanassehi upāyāsehi ādittaṁ. (SN 35.28 simpl.) \ // anki: front
  #fillin(15cm, "¿Por qué está ardiendo? Por los sufrimientos, pesares, desesperaciones está ardiendo.") // anki: back

+ Kassapo kālena odanaṁ bhuñjati. (#emph[Kassapo] es un nombre.) \ // anki: front
  #fillin(15cm, "Kassapa come el arroz en el momento adecuado.") // anki: back

+ Sīlasampanno asammūḷho kālaṁ karoti. \ // anki: front
  #fillin(15cm, "El consumado en virtud muere sin confusión.") // anki: back

+ Nandiyo sakko bhagavantaṁ upasaṅkamati kālena kālaṁ dassanāya. \ (#emph[Nandiyo] es un nombre. #emph[Bhagavant]: el Bienaventurado.) \ // anki: front
  #fillin(15cm, "Nandiyo el sakya se acerca al Bienaventurado de vez en cuando para verlo.") // anki: back
...
+ El hombre va junto con el muchacho. \ // anki: back
  #fillin(15cm, "Naro kumārena saddhiṁ gacchati.") // anki: front

+ Por la no-hostilidad se calma la hostilidad. \ // anki: back
...
#fillin(15cm, "Existe, monjes, un no-nacido, no-originado, no-creado, no-fabricado.") // anki: back

N'atthi me saraṇaṁ aññaṁ, Buddho me saraṇaṁ varaṁ. \ // anki: front
#fillin(15cm, "Para mí no hay otro refugio, el Buddha es mi refugio excelente.") // anki: back

'Atthi me ajjhattaṁ satisambojjhaṅgo'ti pajānāti. (DN 22) \ // anki: front
#fillin(15cm, "'Existe el factor de despertar de la atención plena en mí,' comprende.") // anki: back

Santi sattā apparajakkhajātikā, assavanatā dhammassa parihāyanti. (MN 26) \ // anki: front
#fillin(15cm, "Hay seres con poco polvo en sus ojos. Están decayendo porque no han oído la enseñanza.") // anki: back
...
#fillin(15cm, "Que yo permanezca en bienestar, que esté sin aflicción, que esté sin hostilidad ...") // anki: back
...
+ Sissā ācariyassa bhattaṁ haranti. \ // anki: front
  #fillin(6cm, "Los estudiantes llevan el alimento para el maestro.") // anki: back

+ Kusalaṁ kammaṁ sukhāya saṁvattati. \ // anki: front
  #fillin(6cm, "La acción sana conduce a la felicidad.") // anki: back

+ Mayaṁ phalāni bhuñjāma. \ // anki: front
  #fillin(6cm, "Nosotros comemos las frutas.") // anki: back

+ Sissā pupphāni passanti. \ // anki: front
  #fillin(6cm, "Los estudiantes ven las flores.") // anki: back

], block[
#set enum(start: 5)

+ Narā pupphe haranti. \ // anki: front
  #fillin(6cm, "Los hombres llevan las flores.") // anki: back

+ Rūpe passāmi. \ // anki: front
  #fillin(6cm, "Yo veo las formas.") // anki: back

+ Narā kusalāni kammāni karonti. \ // anki: front
  #fillin(6cm, "Los hombres realizan acciones sanas.") // anki: back

+ Dibbāni pupphāni papatanti. \ // anki: front
  #fillin(6cm, "Flores celestiales están cayendo.") // anki: back
...
+ Rūpaṁ anattā, tasmā rūpaṁ ābādhāya saṁvattati. (SN 22.59) \ // anki: front
  #fillin(15cm, "La forma no es el yo, por lo tanto la forma conduce a la aflicción.") // anki: back

+ Taṁ kiṁ maññatha bhikkhave, rūpaṁ niccaṁ vā aniccaṁ vā'ti? Aniccaṁ bhante. \ // anki: front
  #fillin(15cm, "¿Qué pensáis, monjes, la forma es permanente o impermanente? Impermanente, venerable señor.") // anki: back
...
+ Yaṁ kiñci rūpaṁ atītānāgata-paccuppannaṁ ajjhattaṁ vā bahiddhā vā ... \ // anki: front
  #fillin(15cm, "Cualquier forma, futura, pasada o presente, interna o externa ...") // anki: back
...
+ Ye keci saṅkhārā atītānāgata-paccuppannā ajjhattā vā bahiddhā vā ... \ // anki: front
  #fillin(15cm, "Cualesquiera formaciones mentales, futuras, pasadas o presentes, internas o externas ...") // anki: back
...
+ Los muchachos llevan las flores al monje. \ // anki: back
  #fillin(15cm, "Kumārā bhikkhussa pupphāni haranti.") // anki: front

+ Yo cultivo la mente. \ // anki: back
  #fillin(15cm, "Ahaṁ cittaṁ bhāvemi.") // anki: front

+ Los hombres realizan (hacen) acciones sanas. \ // anki: back
  #fillin(15cm, "Narā kusalāni kammāni karonti.") // anki: front

+ El cocinero prepara (cocina) el alimento para los estudiantes. \ // anki: back
  #fillin(15cm, "Sūdo sissānaṁ bhattaṁ pacati.") // anki: front

+ Nosotros comemos el alimento junto con el maestro. \ // anki: back
...
#table(
  ...
  [#strong[labhati]], [#emph[\(pr)] obtiene; recibe; conseguir (algo para)],
...
#table(
  ...
  [Porque la forma no es el yo, por lo tanto la forma conduce a la aflicción.], // anki: back
)
...
+ Kumāro rukkhamhā patati. \ // anki: front
  #fillin(15cm, "El muchacho cae del árbol.") // anki: back

+ Corā pabbatasmā gāmaṁ dhāvanti. \ // anki: front
  #fillin(15cm, "Los ladrones corren de la montaña a la aldea.") // anki: back

+ Sīhā pabbatehi oruhanti. \ // anki: front
  #fillin(15cm, "Los leones descienden de las montañas.") // anki: back

+ Vihāramhā pattaṁ āharāmi. \ // anki: front
  #fillin(15cm, "Yo traigo el cuenco del monasterio.") // anki: back

+ Dibbāni mandāravapupphāni antalikkhā papatanti. (DN 16) \ // anki: front
  #fillin(15cm, "Flores celestiales de mandārava caen del cielo.") // anki: back

+ Upāsakā samaṇehi saddhiṁ vihārasmā nikkhamanti. \ // anki: front
  #fillin(15cm, "Los devotos laicos parten del monasterio con los monjes.") // anki: back

+ Idāni kasmā so puriso ito nikkhamati? \ // anki: front
  #fillin(15cm, "¿Por qué parte ahora ese hombre de aquí?") // anki: back
...
+ Na kho panāhaṁ cīvarahetu agārasmā anagāriyaṁ pabbajito. (MN 17) \ // anki: front
  #fillin(15cm, "No fue por causa de los hábitos que partí del hogar a la vida sin hogar.") // anki: back

+ Anupādāya āsavehi cittāni vimucciṁsu. (SN 35.28) \ // anki: front
  #fillin(15cm, "Al no aferrarse, sus mentes se liberaron de las impurezas.") // anki: back

+ Avijjāya _(fem.gen.sg., 'de la ignorancia')_ tveva asesa-virāga-nirodhā saṅkhāra-nirodho; \ saṅkhāra-nirodhā viññāṇa-nirodho... \ // anki: front
  #fillin(15cm, "Pero por el total desvanecimiento y cesación de la ignorancia, hay cesación de las formaciones; por la cesación de las formaciones, hay cesación de la conciencia.") // anki: back
...
Esto es la forma, este es el origen/surgimiento de la forma, este es el fin de la forma. // anki: back
...
#quote[
_Dassesi #B[lokassa] (masc.dat.) visuddhi-maggaṁ._ (cántico) \ // anki: front
Él mostró el sendero de la pureza #B[al mundo]. // anki: back

_Yo pana bhikkhu #B[bhikkhussa] (masc.dat.) sāmaṁ cīvaraṁ datvā..._ (NP 25) \ // anki: front
Si un bhikkhu, habiendo dado un hábito #B[a un bhikkhu]... // anki: back

_Yo pana bhikkhu #B[bhikkhussa] (masc.gen.) pattaṁ ... apanidheyya..._ (Pc 60) \ // anki: front
Si un bhikkhu esconde el cuenco #B[de un bhikkhu]... // anki: back

_#B[sāvakānaṁ] (masc.dat.) dhammaṁ desemi #B[sattānaṁ] (masc.gen.) visuddhiyā (fem.dat.)_ (AN 10.95) \ // anki: front
Enseño el Dhamma #B[a los discípulos] para la purificación #B[de los seres]... // anki: back
]
...
#quote[
_Ekaṁ samayaṁ bhagavā sāvatthiyaṁ viharati jetavane anāthapiṇḍikassa ārāme._ (varios) \ // anki: front
En una ocasión el Bienaventurado moraba en Sāvatthī, en la Arboleda de Jeta, en el monasterio de Anāthapiṇḍika. // anki: back
...
¿Y qué en el mundo es agradable y encantador? // anki: back
...
En la aldea o en la selva, cuando es tocado por el placer o por el dolor // anki: back
...
+ Ācariyassa sissā vihāre vasanti. \ // anki: front
  #fillin(15cm, "Los estudiantes del maestro viven en el monasterio.") // anki: back

+ Puriso attano ratane rakkhati. \ // anki: front
  #fillin(15cm, "El hombre guarda sus propios tesoros.") // anki: back

+ Sāvakā Buddhassa dhammaṁ suṇanti. \ // anki: front
  #fillin(15cm, "Los discípulos escuchan la enseñanza del Buddha.") // anki: back

+ Rukkhamūle nisīdāmi, makkaṭā rukkhesu caranti. \ // anki: front
  #fillin(15cm, "Me siento al pie del árbol, los monos deambulan en los árboles.") // anki: back

+ Upāsakassa puttā samaṇehi saddhiṁ vihāraṁ gacchanti. \ // anki: front
  #fillin(15cm, "Los hijos del devoto laico van al monasterio con los monjes.") // anki: back

+ Puriso Anāthapiṇḍikassa ārāme bhattaṁ pacati. \ // anki: front
  #fillin(15cm, "El hombre cocina el alimento en el monasterio de Anāthapiṇḍika.") // anki: back

+ Idha tathāgato loke uppanno arahaṁ sammāsambuddho. (cántico) \ // anki: front
  #fillin(15cm, "Aquí en el mundo ha surgido el Tathāgata, el Digno, el Perfectamente Despierto.") // anki: back

=== Traducir al pāli

#set enum(start: 1)

+ Los discípulos del Buddha se quedan en el monasterio. \ // anki: back
  #fillin(15cm, "Buddhassa sāvakā vihāre viharanti/vasanti.") // anki: front

+ Tú vives en la aldea. \ // anki: back
  #fillin(15cm, "Gāme / gāmamhi / gāmasmiṁ vasasi.") // anki: front

+ Los ciervos (pl.) corren en el bosque. \ // anki: back
  #fillin(15cm, "Migā araññe dhāvanti.") // anki: front

+ El hijo del hombre duerme en la cama. \ // anki: back
  #fillin(15cm, "Narassa putto mañce sayati.") // anki: front

+ El laico da arroz a los monjes. \ // anki: back
...
#fillin(10cm, "No por la hostilidad las hostilidades") // anki: back

sammantīdha kudācanaṁ; \ // anki: front
#fillin(10cm, "se calman aquí alguna vez;") // anki: back

Averena ca sammanti, \ // anki: front
#fillin(10cm, "por la no-hostilidad se calman,") // anki: back

esa dhammo sanantano. \ // anki: front
#fillin(10cm, "esta es una ley eterna.") // anki: back
...
#fillin(10cm, "\"Todas las formaciones son impermanentes\"") // anki: back

yadā paññāya passati; \ // anki: front
#fillin(10cm, "cuando se ve con sabiduría;") // anki: back

Atha nibbindati dukkhe, \ // anki: front
#fillin(10cm, "entonces se desencanta del sufrimiento,") // anki: back

esa maggo visuddhiyā. \ // anki: front
#fillin(10cm, "este es el sendero hacia la purificación.") // anki: back
...
#fillin(10cm, "Intención, monjes, yo llamo acción.") // anki: back

Cetayitvā kammaṁ karoti -- kāyena vācāya manasā. \ // anki: front
#fillin(10cm, "Habiendo intencionado, se actúa — por el cuerpo, el habla, la mente.") // anki: back

Katamo ca, bhikkhave, kammānaṁ nidānasambhavo? \ // anki: front
#fillin(10cm, "¿Y cuál, monjes, es el origen de las acciones?") // anki: back

Phasso, bhikkhave, kammānaṁ nidānasambhavo. \ // anki: front
#fillin(10cm, "El contacto, monjes, es el origen de las acciones.") // anki: back
...
#fillin(7cm, "La diligencia es el sendero de lo inmortal,") // anki: back

2. pamādo maccuno padaṁ; \ // anki: front
#fillin(7cm, "la negligencia es el sendero de la muerte;") // anki: back

3. Appamattā na mīyanti, \ // anki: front
#fillin(7cm, "los diligentes no mueren,") // anki: back

4. ye pamattā yathā matā. \ // anki: front
#fillin(7cm, "los negligentes son como muertos.") // anki: back

], block[
5. Evaṁ visesato ñatvā, \ // anki: front
#fillin(7cm, "Habiendo comprendido esto claramente,") // anki: back

6. appamādamhi paṇḍitā; \ // anki: front
#fillin(7cm, "los sabios (se deleitan) en la diligencia;") // anki: back

7. Appamāde pamodanti, \ // anki: front
#fillin(7cm, "se regocijan en la diligencia,") // anki: back

8. ariyānaṁ gocare ratā. \ // anki: front
#fillin(7cm, "dedicados al/encantados con el dominio de los nobles.") // anki: back
...
#fillin(10cm, "Este es el sendero directo, monjes,") // anki: back

maggo sattānaṁ visuddhiyā, \ // anki: front
#fillin(10cm, "el sendero para la purificación de los seres,") // anki: back

sokaparidevānaṁ samatikkamāya \ // anki: front
#fillin(10cm, "para la superación del pesar y la lamentación,") // anki: back

dukkhadomanassānaṁ atthaṅgamāya \ // anki: front
#fillin(10cm, "para el fin del sufrimiento y la angustia,") // anki: back

ñāyassa adhigamāya \ // anki: front
#fillin(10cm, "para el logro del método correcto,") // anki: back

nibbānassa sacchikiriyāya, \ // anki: front
#fillin(10cm, "para la realización del Nibbāna,") // anki: back

yadidaṁ cattāro satipaṭṭhānā. \ // anki: front
#fillin(10cm, "a saber, los cuatro establecimientos de la atención plena.") // anki: back
...
#fillin(10cm, "El fin del mundo no se alcanza") // anki: back

lokassanto kudācanaṁ; \ // anki: front
#fillin(10cm, "viajando, jamás;") // anki: back

Na ca appatvā lokantaṁ, \ // anki: front
#fillin(10cm, "sin embargo, sin alcanzar el fin del mundo,") // anki: back

dukkhā atthi pamocanaṁ. \ // anki: front
#fillin(10cm, "no hay liberación del sufrimiento.") // anki: back
